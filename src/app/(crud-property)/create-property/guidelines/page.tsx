            ...
            <div className="grid items-center gap-4 lg:grid-cols-2 lg:gap-12">
              ...
              <div>
                ...
                <p className="text-md text-gray-600">
                  By clicking <b> &quot;Continue &quot;</b>, you agree that all
                  the information provided is true and accurate, and that you
                  have read and understood our property posting guidelines.
                </p>
              </div>
